...
//┃
//┃ YOU WANT UNENCRYPTED SCRIPT https://wa.me/263718635356
//┗━━━━━━━━━━━━━━━━━━━━━━━━━
//
require('./config')
    ...
    ZimBotInc.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let link = `https://www.youtube.com/c/Team263Hacks?sub_confirmation=1'`
let buttons = [
...
headerType: 4,
contextInfo:{externalAdReply:{
title: `BYE, IT WAS NICE HAVING YOU.....JOKING WE WON'T EVEN MISS YOU, HAHAHA.😂🤣...BY THE WAY DONT COME BACK`,
body: `SUBSCRIBE TO OUR CHANNEL`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
