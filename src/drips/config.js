...
// Other
global.owner = ['263718635356','263782078628']
global.premium = ['263718635356','263782078628']
global.botname = 'ZeD BOT INC'
global.ownername ='Hxcker-263'
global.packname = 'ZED BOT INC'
global.quoted = 'https://www.youtube.com/c/Team263Hacks?sub_confirmation=1'
...
global.mess = {
    ...
    admin: '*this cmd is for admins only , l can feel you but sorry okay*',
    ...
    wait: '*whoa wait Zed bot processing okay*',
    endLimit: '*Brothers/Sisters Daily Limit Has Expired, Type .buy limit amount limit to buy limit, Note: Limit will be reset every 12 hours*',
}
global.limitawal = {
    premium: "Infinity",
    free: 25
